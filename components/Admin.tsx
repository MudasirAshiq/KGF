...
import { getData, updateData, checkAuth, changeAdminPassword } from '../services/dataService';
...
const Admin: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'vision' | 'products' | 'founder' | 'stats' | 'contact' | 'policy' | 'calorific' | 'model' | 'settings'>('vision');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
            ...
            {activeTab === 'settings' && (
              <div className="space-y-6">
                <h3 className="text-xl font-bold text-stone-800 border-b pb-4">Admin Settings</h3>
                <div>
                  <label className="block text-sm font-medium text-stone-600 mb-2">Change Admin Password</label>
                  <div className="space-y-4">
                    <input
                      type="password"
                    ...
                    <button
                      ...
                      className="bg-emerald-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-emerald-500 transition-colors"
                    >
                      Change Password
                    </button>
                  </div>
